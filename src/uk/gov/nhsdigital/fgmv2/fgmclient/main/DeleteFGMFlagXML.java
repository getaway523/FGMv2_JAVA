...
public class DeleteFGMFlagXML {
	...
	public static MessageHeader createMessageHeader(){
		...
		event.setCode("urn:nhs:names:services:clinicals-sync:FGMDelete_1_0");
		msgH.setEvent(event);
		...
		msgH.setAuthor(new ResourceReferenceDt().setReference("Practitioner/41fe704c-18e5-11e5-b60b-1697f925ec7b"));
	...
	public static Parameters createParameters() {
		...
		ResourceMetadataMap meta = new ResourceMetadataMap();
		meta.put(ResourceMetadataKeyEnum.PROFILES, "http://fhir.nhs.net/StructureDefinition/spine-fgmdelete-parameters-1-0");
		...
		param1.setName("FGMDeleteReason");
		CodeableConceptDt codeableConceptDelParam = new CodeableConceptDt();
		codeableConceptDelParam.addCoding().setSystem("http://fhir.nhs.net/ValueSet/fgm-delete-reason-codes-1-0").setCode("1");
		param1.setValue(codeableConceptDelParam);
		param.addParameter(param1);
